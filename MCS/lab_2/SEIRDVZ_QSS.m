...
% zeta  -- average zombie-fighting capacity
% mu_z  -- average mortality of zombie attack
...
f = @(t, seirdv)SEIRDVZ_ODE_QSS(t, seirdv, p);
...
% title(sprintf(['SEIRDVZ,  \x03b2 = %0.3f,  ', ...
%                        '\x03ba = %0.3f,  ', ...
%                        '\x03b3 = %0.3f,  ', ...
%                        'I_{0} = %0.3e'], ...
...
xlabel('Time (weeks)');
ylabel('Fraction of population');
legend('Susceptible', 'Exposed', 'Infectious', 'Recovered', 'Dead', 'Vaccinated', 'Zombies');
...
xlim(tspan);
ylim([0,1]);
title(tl, sprintf(['SEIRDVZ,  \x03b2 = %0.3f,  ', ...
                           '\x03ba = %0.3f,  ', ...
                           '\x03b3 = %0.3f,  ', ...
                           'I_{0} = %0.2e'], ...
              p.beta, p.kappa, p.gamma, I0));
