...
public class CDTLZ2 extends Problem {

    private double[] hpCoefficients_;

	public CDTLZ2(String solutionType) throws ClassNotFoundException {
		this(solutionType, 12, 5);
	}

	public CDTLZ2(String solutionType, Integer numberOfVariables,
