...
public class CDTLZ4 extends Problem {

    private double[] hpCoefficients_;

	public CDTLZ4(String solutionType) throws ClassNotFoundException {
		this(solutionType, 12, 5);
	}

	public CDTLZ4(String solutionType, Integer numberOfVariables, Integer numberOfObjectives) {
