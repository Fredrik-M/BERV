...
public class ICDTLZ3 extends Problem {

    private double[] hpCoefficients_;

	public ICDTLZ3(String solutionType) throws ClassNotFoundException {
		this(solutionType, 12, 5);
	}

	public ICDTLZ3(String solutionType, Integer numberOfVariables, Integer numberOfObjectives) {
		numberOfVariables_ = numberOfVariables;
		numberOfObjectives_ = numberOfObjectives + 1;
		numberOfConstraints_ = 7;
        problemName_ = "ICDTLZ3";
